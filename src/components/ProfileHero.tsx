    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center relative">
      <div className="flex items-center space-x-12">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h1
            className="text-6xl font-bold font-helixa uppercase"
            style={{ fontFamily: "Helixa Light, sans-serif" }}
          >
            <span
            ...
            <span className="text-odonnellGray dark:text-foreground">
              onnell
            </span>
          </h1>
        </div>
        ...
        <div className="space-y-6 text-2xl text-muted-foreground dark:text-gray-200 font-helixa">
          <p className={`${showTaglines ? "fadeInUp-animation" : "opacity-0"}`}>
            Originally from{" "}
            <span className="font-callestany text-3xl">Ireland</span>
          </p>

          <p className={`${showTaglines ? "fadeInUp-animation" : "opacity-0"}`}>
            Based in <span className="font-callestany text-3xl">Sydney</span>
          </p>

          <p className={`${showTaglines ? "fadeInUp-animation" : "opacity-0"}`}>
            Working at{" "}
            <span className="font-callestany text-stripe text-3xl">Stripe</span>
          </p>
        </div>
      </div>
