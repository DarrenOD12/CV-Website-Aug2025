...
const experiences = [
  {
    ...
    achievements: [
      ...
      "Identified critical payment and onboarding vulnerability in network policy changes, led cross-functional initiative with internal stakeholders and payment network partners to implement solution protecting +7 million cards from processing failures while adapting to evolving payment network policies",
      "Developed and published customer-facing Stripe documentation while ranking in top 0.5% of internal knowledge contributors based on document creation volume; delivered high-impact educational presentations across Sales, Professional Services, and Solution Architect teams to strengthen cross-functional expertise",
    ],
  },
  {
    company: "PwC",
