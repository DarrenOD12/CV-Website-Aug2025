  ...
  return (
    <div className="min-h-screen bg-background py-16 px-4">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-4xl font-bold text-center text-foreground mb-12 font-helixa">Education</h2>
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 w-full text-left">
                  <div className="flex-1">
                    <div className="flex items-center gap-3">
                      <div className="text-3xl font-bold text-foreground font-callestany">{edu.institution}</div>
                    </div>
                    <div className="text-lg font-light text-foreground mt-1 font-helixa">{edu.degree}</div>
                    <div className="text-sm text-muted-foreground mt-2 font-helixa line-clamp-1 data-[state=open]:hidden">
                      {edu.achievements[0]}
                    </div>
                  </div>
                  <div className="text-right flex-shrink-0">
                    <div className="text-sm text-muted-foreground font-helixa">{edu.period}</div>
                  </div>
                </div>
              </AccordionTrigger>
